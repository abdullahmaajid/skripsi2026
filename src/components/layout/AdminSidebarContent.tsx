        ...
        {loading && !stats ? (
          ...
          <>
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="col-span-2 bg-indigo-500 rounded-[1.5rem] p-5 text-white flex justify-between items-center relative overflow-hidden">
                <div>
                  <h4 className="text-indigo-100 font-medium text-[10px] uppercase tracking-wider mb-1">Siswa Aktif Terdaftar</h4>
              ...
              <div className="bg-slate-50 border border-slate-100 rounded-[1.5rem] p-4 flex flex-col justify-between aspect-square group hover:bg-purple-50 transition-colors">
              ...
              <div className="bg-slate-50 border border-slate-100 rounded-[1.5rem] p-4 flex flex-col justify-between aspect-square group hover:bg-rose-50 transition-colors">
                <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-rose-500 shadow-sm group-hover:scale-110 transition-transform">
              ...
              <div className="col-span-2 bg-white border border-slate-200 rounded-[1.5rem] p-4 flex items-center justify-between shadow-sm">
              ...
              <div className="bg-slate-900 rounded-[1.5rem] p-4 flex flex-col justify-between aspect-square group">
                <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-emerald-400">
                  <CheckCircle2 className="w-4 h-4" />
                </div>
                <div>
                  <div className="text-3xl font-black text-white tracking-tight">{stats.exams.attempts}</div>
