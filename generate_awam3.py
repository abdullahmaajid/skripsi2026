...
- **Siswa** memiliki cabang pilihan awal:
  - **Opsi 1 (Opsional):** Bertanya di chat panel AI sebelum menebak jawaban. **AI Tutor** merespons dengan memberikan petunjuk tipis (*hint*) tanpa membocorkan kunci.
...
- **Sistem** langsung mengecek kebenaran jawaban tersebut.
  ...
  - **Jika salah (Percobaan 2 / Habis):** **Sistem** mengubah status soal menjadi "Dilewati". **AI Tutor** otomatis mengirim chat evaluasi. **Siswa** memiliki cabang pilihan:
    ...
    - **Opsi 2:** Langsung mengeklik "Lanjut" ke soal berikutnya.
  - **Jika benar:** **Sistem** memunculkan notifikasi "Benar!" dan tombol "Lihat Pembahasan AI". **AI Tutor** otomatis mengirim chat apresiasi. **Siswa** memiliki cabang pilihan:
    - **Opsi 1:** Mengobrol dengan **AI Tutor** (Siswa tetap tertahan di soal ini).
    - **Opsi 2:** Mengeklik tombol "Lihat Pembahasan AI" (Siswa tetap tertahan di soal ini).
    - **Opsi 3 (Wajib):** Mengeklik tombol "Lanjut" ke soal berikutnya.
...
- **Siswa** dihadapkan pada percabangan interaksi yang akan terus me-loop (berputar):
  - **Opsi 1:** Memilih nomor soal lain di navigasi. **Sistem** memuat detail soal baru tersebut.
  - **Opsi 2:** Mengeklik tombol "Tanya Pembahasan AI". **AI Tutor** merespons dengan penjabaran konsep.
  - **Opsi 3:** Mengirim chat balasan bebas. **AI Tutor** membalas secara interaktif.
  - **Opsi 4:** Keluar dari halaman pembahasan, menandakan alur ini selesai.
- **Status Akhir Alur:** [Lingkaran Hitam Sempurna (Selesai)]

### 5. Ulangi Latihan
- *Alur ini dimulai dari (Konektor A).*
...
- *Alur ini dimulai dari (Konektor C).*
...
- *Alur ini dimulai dari (Konektor A & B).*
...
- *Alur ini dimulai dari (Konektor B).*
